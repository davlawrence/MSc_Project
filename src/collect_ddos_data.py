...
from lib.application_parameters import delay, data_directory, attacks_data_filename, agg_attacks_data_filename, bytes_filename, packets_filename, src_ip_filename, dst_ip_filename, netflow_filename
...
class CollectDDoSAttacksDatasetApp(SimpleSwitch13):

    def __init__(self, *args, **kwargs):
        super(CollectDDoSAttacksDatasetApp, self).__init__(*args, **kwargs)
        
        self.data_filename = os.path.join(data_directory, attacks_data_filename)
        ...
        self.agg_data_filename = os.path.join(data_directory, agg_attacks_data_filename)
        create_directory(data_directory)
