...
MQTTPORT=1883
UDPPORT=1883
FORWARDER="127.0.0.1" # this host
MQTT2MULTICAST_IP_ADDR_SERVER="10.0.0.251"
...
#python3 ./mqtt_proxy_m2m.py -t ${MQTTPORT} -u ${USERNAME} -p ${PASSWORD} -U ${UDPPORT} -s ${MQTT2MULTICAST_IP_ADDR_SERVER} -S ${MQTT2MULTICAST_UDP_PORT_SERVER} -C ${MQTT2MULTICAST_UDP_PORT_CLIENT}
